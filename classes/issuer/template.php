...
<body style="margin:0">
	...
	<div class="container-fluid" style="background-color:#CEE5F2;margin-top:40px;color:#B0413E;">
		...
		<section id="tabs">
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 ">
						<nav>
							<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist" style="background-color:#B0413E;border-radius:10px">
						...
						<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
							<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
								<div class="container-fluid">
									<div class="row">
										<div class="col-md-3 col-sm-4" style="height:214px;width:384;margin-right:100px;margin-top:30px;">
											<img src="../../assets/images/certificate_templates/t1.png" alt="">
										</div>
										<div class="col-md-3 col-sm-4" style="height:214px;margin-right:100px;margin-top:30px">
											<img src="../../assets/images/certificate_templates/t1.png" alt="">
										</div>
										<div class="col-md-3 col-sm-4" style="height:214px;margin-top:30px">
										<img src="../../assets/images/certificate_templates/t1.png" alt="">
										</div>
